...
npb = ggplot(nd2, aes(x = Site, y = Result, fill = Analyte)) +
...
nut_ts = ggplot(nd2, aes(x = Date, y = Result, fill = Site))
...
fpts + scale_fill_manual(values = c('#56B4E9','#D55E00', '#009E73', '#CC79A7', '#0072B2' )) + guides(fill = FALSE)
